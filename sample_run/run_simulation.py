...
def run_sim(model_type):
    ...
    device = Device(250, 1.8, '../reference_cs.xlsx')
    ...
    accuracy = {'trials_count': 10, 'particles_count': 10000, 'let_values_count': 300}
    ...
    output_file.save_data(results.T, columns=['LET', 'mean number', 'std dev', 'cross-section'])
...
def main():
    run_sim('point')  # currently, only "point" model is working correctly
    run_ser()
    pass
